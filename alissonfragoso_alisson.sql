...
--
-- Host: 127.0.0.1
-- Tempo de geração: 22/06/2024 às 02:23
...
--
-- Banco de dados: `alissonfragoso_alisson`
--
...
CREATE TABLE `reacao` (
  ...
  `cod_foto` int(11) NOT NULL,
  `cod_usuario` int(11) NOT NULL,
  `data_hora_reacao` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `reacao` (`Cod`, `cod_foto`, `cod_usuario`, `data_hora_reacao`) VALUES
(8, 7, 1, '2024-06-21 00:00:00'),
(24, 8, 1, '2024-06-21 00:00:00'),
(28, 3, 1, '2024-06-21 00:00:00'),
(29, 1, 2, '2024-06-21 00:00:00'),
(33, 2, 2, '2024-06-21 00:00:00'),
(34, 7, 2, '2024-06-21 00:00:00'),
(35, 8, 2, '2024-06-21 00:00:00'),
(36, 5, 2, '2024-06-21 00:00:00'),
(37, 6, 2, '2024-06-21 00:00:00'),
(39, 3, 2, '2024-06-21 00:00:00');
